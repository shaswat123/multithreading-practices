...
public class SchedulingTaskForFixedRateRepeatedExecutions {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        timer.scheduleAtFixedRate(new ScheduleTaskA(1000L, "1"), scheduleTime, intervalMills);
        ...
        timer.scheduleAtFixedRate(new ScheduleTaskA(1000L, "2"), delayInMills, intervalInMills);
